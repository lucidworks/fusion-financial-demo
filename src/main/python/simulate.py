...
p.add_option('--historical_port', action='store',
             dest='historical_port', default='9898')
# Index the content
p.add_option('-x', '--index', action='store_true', dest='index')
...
opts.historical_solr = 'http://' + opts.host + \
    ':' + opts.historical_port + '/solr'
