...
(function () {
  ...
  /**
    ...
    */
  sjs.DateHistogramFacet = function (name) {
  ...
  /**
    ...
    */
  sjs.GeoDistanceFacet = function (name) {
  ...
  /**
    ...
    */
  sjs.HistogramFacet = function (name) {
  ...
  /**
    ...
    */
  sjs.StatisticalFacet = function (name) {
  ...
  /**
    ...
    */
  sjs.TermStatsFacet = function (name) {
  ...
  /**
    ...
    */
  sjs.ExistsFilter = function (fieldName) {
  ...
  /**
    ...
    */
  sjs.GeoBboxFilter = function (fieldName) {
  ...
  /**
    ...
    */
  sjs.GeoDistanceFilter = function (fieldName) {
  ...
  /**
    ...
    */
  sjs.GeoDistanceRangeFilter = function (fieldName) {
  ...
  /**
    ...
    @param {String} fieldName the document property/field containing the Geo Point (lon/lat).
    */
  sjs.GeoPolygonFilter = function (fieldName) {
  ...
  /**
    ...
    */
  sjs.GeoShapeFilter = function (field) {
  ...
  /**
    ...
    */
  sjs.HasChildFilter = function (qry, type) {
  ...
  /**
    ...
    */
  sjs.HasParentFilter = function (qry, parentType) {
  ...
  /**
    ...
    @param {String || Array} indices a single index name or an array of index 
      names.
    */
  sjs.IndicesFilter = function (fltr, indices) {
  ...
  /**
    ...
    */
  sjs.LimitFilter = function (limit) {
  ...
  /**
    ...
    */
  sjs.MissingFilter = function (fieldName) {
  ...
  /**
     ...
     */
  sjs.NestedFilter = function (path) {
  ...
  /**
    ...
    */
  sjs.NotFilter = function (oFilter) {
  ...
  /**
    ...
    */
  sjs.NumericRangeFilter = function (fieldName) {
  ...
  /**
    ...
    */
  sjs.PrefixFilter = function (fieldName, prefix) {
  ...
  /**
    ...
    */
  sjs.RangeFilter = function (field) {
  ...
  /**
    ...
    */
  sjs.RegexpFilter = function (field, value) {
  ...
  /**
    ...
    */
  sjs.ScriptFilter = function (script) {
  ...
  /**
    ...
    */
  sjs.TermFilter = function (fieldName, term) {
  ...
  /**
    ...
    */
  sjs.TermsFilter = function (field, terms) {
  ...
  /**
    ...
    */
  sjs.Document = function (index, type, id) {
  ...
  /**
     ...
     */
  sjs.BoostingQuery = function (positiveQry, negativeQry, negativeBoost) {
  ...
  /**
    ...
    */
  sjs.CommonTermsQuery = function (field, qstr) {
  ...
  /**
     ...
     */
  sjs.ConstantScoreQuery = function () {
  ...
  /**
    ...
    @param {Object} qry A valid query object.
    */
  sjs.CustomBoostFactorQuery = function (qry) {
  ...
  /**
    ...
    @param {Object || Array} filters A single object or array of objects.  Each 
      ...
      property.
    */
  sjs.CustomFiltersScoreQuery = function (qry, filters) {
  ...
  /**
    ...
    */
  sjs.CustomScoreQuery = function (qry, script) {
  ...
  /**
    ...
    */
  sjs.FieldMaskingSpanQuery = function (spanQry, field) {
  ...
  /**
    ...
    */
  sjs.FieldQuery = function (field, qstr) {
  ...
  /**
     ...
     */
  sjs.FilteredQuery = function (someQuery, someFilter) {
  ...
  /**
    ...
    */
  sjs.FuzzyLikeThisFieldQuery = function (field, likeText) {
  ...
  /**
    ...
    @param {String} likeText The text to find documents like it.
    */
  sjs.FuzzyLikeThisQuery = function (likeText) {
  ...
  /**
     ...
     */
  sjs.FuzzyQuery = function (field, value) {
  ...
  /**
    ...
    */
  sjs.GeoShapeQuery = function (field) {
  ...
  /**
    ...
    @param {String} type The child type
    */
  sjs.HasChildQuery = function (qry, type) {
  ...
  /**
    ...
    @param {String} parentType The child type
    */
  sjs.HasParentQuery = function (qry, parentType) {
  ...
  /**
    ...
    @param {String || Array} indices a single index name or an array of index 
      names.
    */
  sjs.IndicesQuery = function (qry, indices) {
  ...
  /**
    ...
    @param {String} qstr the query string
    */
  sjs.MatchQuery = function (field, qstr) {
  ...
  /**
     ...
     */
  sjs.MoreLikeThisFieldQuery = function (field, likeText) {
  ...
  /**
     ...
     */
  sjs.MoreLikeThisQuery = function (fields, likeText) {
  ...
  /**
    ...
    @param {String} qstr the query string
    */
  sjs.MultiMatchQuery = function (fields, qstr) {
  ...
  /**
    ...
    */
  sjs.PrefixQuery = function (field, value) {
  ...
  /**
    ...
    */
  sjs.QueryStringQuery = function (qstr) {
  ...
  /**
    ...
    @param {String} value A regex pattern.
    */
  sjs.RegexpQuery = function (field, value) {
  ...
  /**
    ...
    */
  sjs.SpanFirstQuery = function (spanQry, end) {
  ...
  /**
    ...
    */
  sjs.SpanNearQuery = function (clauses, slop) {
  ...
  /**
    ...
    */
  sjs.SpanNotQuery = function (includeQry, excludeQry) {
  ...
  /**
    ...
    */
  sjs.SpanOrQuery = function (clauses) {
  ...
  /**
    ...
    */
  sjs.SpanTermQuery = function (field, value) {
  ...
  /**
    ...
    */
  sjs.TermQuery = function (field, term) {
  ...
  /**
    ...
    */
  sjs.TermsQuery = function (field, terms) {
  ...
  /**
    ...
    */
  sjs.TopChildrenQuery = function (qry, type) {
  ...
  /**
    ...
    @param {String} value the literal value to be matched
    */
  sjs.WildcardQuery = function (field, value) {
  ...
  /**
    ...
    */
  sjs.IndexedShape = function (type, id) {
  ...
  sjs.Request = function (conf) {
    ...
    var query, indices, types, params = {},
      ...
      getRestPath = function (endpoint) {
        ...
        // Solr do not need to use any indices and types.
        // join any indices
        // if (indices.length > 0) {
    ...
    return {
      ...
      doDeleteByQuery: function (successcb, errorcb) {
        ...
        return sjs.client.del(getRestPath('_query'), queryData, successcb, errorcb);
      },
      ...
      doSearch: function (successcb, errorcb) {
        ...
        // I cannot find a way for Solr to accept HTTP POST query with JSON params
        // So I have to send query params as a string (same as GET query format).
  ...
  /**
    ...
    */
  sjs.ScriptField = function (fieldName) {
    var script = {};
  ...
  /**
    ...
    */
  sjs.Shape = function (type, coords) {
  ...
  /**
    ...
    */
  sjs.DirectGenerator = function () {

  
    var

    // common suggester options used in this generator
    _common = sjs.DirectSettingsMixin(),
  ...
  /**
    ...
    */
  sjs.DirectSettingsMixin = function () {
  ...
  /**
    ...
    */
  sjs.PhraseSuggester = function (name) {
  ...
  /**
    ...
    @param {String} name The name which be used to refer to this suggester.
    */
  sjs.TermSuggester = function (name) {
